...
## 🖥️ التشغيل على Windows (الطريقة الأسهل!)

### ما تحتاجه:
فقط قم بتنزيل هذين الملفين **مرة واحدة**:

| الملف | الرابط | الحجم |
|-------|--------|-------|
| Python 3.11 | [تنزيل](https://www.python.org/ftp/python/3.11.9/python-3.11.9-embed-amd64.zip) | ~15 MB |
| MongoDB 6.0 | [تنزيل](https://fastdl.mongodb.org/windows/mongodb-windows-x86_64-6.0.13.zip) | ~475 MB |
...
1. **جهّز المجلدات:**
   ...
   ├── mongodb/         ← فك ضغط MongoDB هنا
   │   └── bin/         ← تأكد من وجود mongod.exe
   ├── backend/         ← موجود في المشروع
   ├── frontend/        ← موجود في المشروع
   ├── Setup.bat        ← موجود في المشروع
   └── Start.bat        ← موجود في المشروع
   ```
...
## 🐳 التشغيل بـ Docker (بديل)

### المتطلبات:
- [Docker Desktop](https://www.docker.com/products/docker-desktop) فقط!
...
4. **ميزات AI معطلة محلياً** - قراءة الهوية وتحليل الحوالات بالذكاء الاصطناعي تعمل فقط على منصة Emergent
