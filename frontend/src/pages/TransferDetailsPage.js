...
import { printDocument, generateTransferReceiptHTML, generateVoucherHTML } from '../utils/printUtils';
              ...
              <Card className="border-2 border-secondary" data-testid="receive-form">
                ...
                <CardContent className="pt-6">
                  <form onSubmit={handleReceiveSubmit} className="space-y-6">
                    ...
                    <div className="space-y-4">
                      <Label className="text-base font-bold">صورة الهوية أو جواز السفر (مطلوبة) *</Label>
                      <p className="text-sm text-gray-600">
                        📸 التقط صورة واضحة لهويتك الشخصية أو جواز سفرك
                      </p>
